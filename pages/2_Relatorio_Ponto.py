    ...
    with subtab_dados:
        ...
        if not rows_resumo:
            ...
            df_r.rename(columns={
                ...
                "domingos_trabalhados":  "Domingos Trabalhados",
                "feriados_trabalhados":  "Feriados Trabalhados",
            ...
            hide_index=True,
            column_config={
                "Dias Trabalhados":     st.column_config.NumberColumn(format="%d"),
                "Horas Trabalhadas":    st.column_config.TextColumn(),
                ...
                "Domingos Trabalhados": st.column_config.NumberColumn(format="%d"),
                "Feriados Trabalhados": st.column_config.NumberColumn(format="%d"),
